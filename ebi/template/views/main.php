    ...
    <div class="container">
        ...
        <header class="d-flex align-items-center justify-content-between mb-3">
            ...
            <div class="d-flex align-items-center" style="min-width: 220px; justify-content: flex-end;">
                ...
                <a href="<?php echo defined('INSTANCE_DIR') ? '../../../selfservice/apresentacao.html' : '../selfservice/apresentacao.html'; ?>" class="btn btn-outline-secondary btn-sm mr-1" target="_blank" title="O que é o sistema?"><i class="fas fa-play-circle mr-1"></i>Sobre</a>
