    ...
    <div class="container">
        ...
        <header class="d-flex align-items-center justify-content-between mb-3">
            ...
            <div class="d-flex align-items-center" style="min-width: 220px; justify-content: flex-end;">
                ...
                <a href="<?php echo defined('INSTANCE_DIR') ? '../../../selfservice/apresentacao-6.html' : '../selfservice/apresentacao-6.html'; ?>" class="btn btn-outline-secondary btn-sm mr-1" target="_blank" title="Apresentacao V6"><i class="fas fa-clapperboard mr-1"></i>V6</a>
