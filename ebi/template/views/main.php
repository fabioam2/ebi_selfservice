    ...
    <div class="container">
        ...
        <header class="d-flex align-items-center justify-content-between mb-3">
            ...
            <div class="d-flex align-items-center" style="min-width: 220px; justify-content: flex-end;">
                ...
                <a href="<?php echo defined('INSTANCE_DIR') ? '../../../selfservice/apresentacao.html' : '../selfservice/apresentacao.html'; ?>" class="btn btn-outline-secondary btn-sm mr-1" target="_blank" title="Apresentacao V1"><i class="fas fa-play-circle mr-1"></i>V1</a>
                <a href="<?php echo defined('INSTANCE_DIR') ? '../../../selfservice/apresentacao-2.html' : '../selfservice/apresentacao-2.html'; ?>" class="btn btn-outline-secondary btn-sm mr-1" target="_blank" title="Apresentacao V2"><i class="fas fa-film mr-1"></i>V2</a>
                <a href="<?php echo defined('INSTANCE_DIR') ? '../../../selfservice/apresentacao-3.html' : '../selfservice/apresentacao-3.html'; ?>" class="btn btn-outline-secondary btn-sm mr-1" target="_blank" title="Apresentacao V3"><i class="fas fa-rocket mr-1"></i>V3</a>
                <a href="<?php echo defined('INSTANCE_DIR') ? '../../../selfservice/apresentacao-4.html' : '../selfservice/apresentacao-4.html'; ?>" class="btn btn-outline-secondary btn-sm mr-1" target="_blank" title="Apresentacao V4"><i class="fas fa-magic mr-1"></i>V4</a>
                <a href="<?php echo defined('INSTANCE_DIR') ? '../../../selfservice/apresentacao-5.html' : '../selfservice/apresentacao-5.html'; ?>" class="btn btn-outline-secondary btn-sm mr-1" target="_blank" title="Apresentacao V5"><i class="fas fa-star mr-1"></i>V5</a>
                <a href="<?php echo defined('INSTANCE_DIR') ? '../../../selfservice/apresentacao-6.html' : '../selfservice/apresentacao-6.html'; ?>" class="btn btn-outline-secondary btn-sm mr-1" target="_blank" title="Apresentacao V6"><i class="fas fa-star mr-1"></i>V6</a>
                <a href="<?php echo defined('INSTANCE_DIR') ? '../../../selfservice/apresentacao-7.html' : '../selfservice/apresentacao-7.html'; ?>" class="btn btn-outline-success btn-sm mr-1" target="_blank" title="O que é o sistema"><i class="fas fa-play-circle mr-1"></i>O que é?</a>
