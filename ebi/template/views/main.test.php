                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuAdmin">
                    ...
                    <div class="dropdown-submenu">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <?php
                            // URL do download: relativo ao diretório do script atual
                            // ebi.test.php está em ebi/template/ → subir 1 nível para ebi/
                            // instância está em ebi/i/user_XXX/ → subir 2 níveis para ebi/
                            $qzDownload = defined('INSTANCE_DIR')
                                ? '../../drive%20QZtray/QZTray%20e%20Certificados%20.zip'
                                : '../drive%20QZtray/QZTray%20e%20Certificados%20.zip';
                            ?>
                            <a class="dropdown-item" href="<?php echo $qzDownload; ?>" download="QZTray_e_Certificados.zip">
