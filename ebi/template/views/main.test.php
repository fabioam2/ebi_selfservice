                            ...
                            <div class="col-md-6 mb-3">
                                <div class="border rounded p-3 h-100">
                                    ...
                                    <div class="alert alert-success mb-0 p-2 small">
                                        <strong>Gerar QR Codes:</strong> Acesse o botão <strong>QrCode</strong> no canto superior direito ou clique <a href="<?php echo defined('INSTANCE_DIR') ? '../../../qrcode/qrcode.2.php' : '../../qrcode/qrcode.2.php'; ?>" target="_blank">aqui</a> para criar os QR Codes dos responsáveis com seus dados pré-preenchidos.
                                    </div>
                                </div>
                            </div>
                            <!-- Passo 3 -->
