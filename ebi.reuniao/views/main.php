...
<head>
    ...
    <title>Reunião - Espaço Bíblico Infantil</title>
        ...
        <form method="post" action="<?php echo sanitize_for_html($_SERVER["PHP_SELF"]); ?>" class="mb-3 p-3 border rounded bg-light shadow-sm" id="formNovoCadastro">
            ...
            <div class="form-row align-items-center form-registro-linha">
                <div class="form-group col-md col-nome-crianca">
                    ...
                    <select class="form-control form-control-sm cadastro-input" id="input_<?php echo $linha; ?>_0" name="nome_crianca[]" data-linha="<?php echo $linha; ?>" data-col="0">
                        <option value=""></option>
                ...
                <div class="form-group col-md col-responsavel">
                    <label for="input_<?php echo $linha; ?>_1" class="d-md-none">Nome <?php echo $linha + 1; ?>:</label>
