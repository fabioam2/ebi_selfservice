...
<head>
    ...
    <title>Acesso à Reunião - Espaço Bíblico Infantil</title>
...
<body>
    ...
    ?>
    <div class="login-context"><?php echo sanitize_for_html($contextoLogin !== '' ? $contextoLogin : 'Reunião do Espaço Bíblico Infantil'); ?></div>
    <main class="login-container" aria-labelledby="login-title">
        <div class="login-brand" aria-hidden="true"><i class="fas fa-child"></i></div>
        <h1 id="login-title">Acesso à Reunião</h1>
