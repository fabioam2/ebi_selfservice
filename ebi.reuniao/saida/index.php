<?php
/**
 * Login e Interface de Registro de Saída da Reunião
...
<head>
    ...
    <title>Acesso - Saída da Reunião</title>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1">
    <title>Registrar Saída da Reunião</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css">
    <link href="https://fonts.googleapis.com/css2?family=Manrope:wght@500;700;800&display=swap" rel="stylesheet">
    <style>
        :root {
...
<body>
    <div class="container">
        <div class="header">
            <h1><i class="fas fa-door-open"></i> Saída da Reunião</h1>
        ...
        <div class="link-painel"><a href="painel.php"><i class="fas fa-tv mr-1"></i>Ver Painel da Reunião</a></div>
    </div>
